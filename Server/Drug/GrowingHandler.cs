...
namespace Server.Drug
{
    public class GrowingHandler
    {
        ...
        public static void LoadMarijuana(Marijuana marijuana)
        {
            ...
            {
                // Flowering Object
                marijuanaObject = PropStreamer.Create("bkr_prop_weed_med_01b", Marijuana.Position(marijuana) - new Position(0, 0, 1.0f),
                    new Vector3(0,0,0), dimension: marijuana.Dimension, visible: true, frozen: true);
            }
            ...
            {
                // Harvest Object
                marijuanaObject = PropStreamer.Create("bkr_prop_weed_lrg_01b", Marijuana.Position(marijuana) - new Position(0, 0, 1.0f),
                    new Vector3(0,0,0), dimension: marijuana.Dimension, visible: true, frozen: true);
            }
