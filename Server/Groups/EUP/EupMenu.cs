...
namespace Server.Groups.EUP
{
    public class EupMenu
    {
        ...
        public static List<EupProp> FemalePoliceProps = new List<EupProp>
        {
            ...
            new EupProp("Duty Belt 2", EupPropType.Clothing,8, new []{217, 0}),
            new EupProp("Duty Belt 3", EupPropType.Clothing,8, new []{218, 0}),
            new EupProp("Duty Belt 4", EupPropType.Clothing,8, new []{220, 0}),
            new EupProp("Duty Belt 5", EupPropType.Clothing,8, new []{221, 0}),
            new EupProp("Duty Belt 6", EupPropType.Clothing,8, new []{223, 0}),
            new EupProp("Duty Belt 7", EupPropType.Clothing,8, new []{224, 0}),
            new EupProp("Duty Belt 8", EupPropType.Clothing,8, new []{225, 0}),
            new EupProp("Duty Belt 9", EupPropType.Clothing,8, new []{226, 0}),
            new EupProp("Duty Belt 10", EupPropType.Clothing,8, new []{227, 0}),
