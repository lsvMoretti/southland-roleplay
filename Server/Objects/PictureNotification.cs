...
namespace Server.Objects
{
    ...
    {
        /// <summary>
        /// Title of PictureNotification
        /// </summary>
        public string Title { get; set; }

        /// <summary>
        /// Description of PictureNotification
        /// </summary>
        public string Description { get; set; }

        /// <summary>
        /// Message of PictureNotification
        /// </summary>
        public string Message { get; set; }

        /// <summary>
        /// PictureNotification Type
        /// </summary>
        public string NotificationType { get; set; }

        /// <summary>
        /// Flashes the notification
        /// </summary>
        public bool FlashNotification { get; set; }
        ...
        public PictureNotification(string title, string description, string message, PictureNotificationType notificationType, bool flashNotification, int time)
        {
            Title = title;
        ...
        public static void ShowPictureNotification(IPlayer player, PictureNotification pictureNotification)
        {
            player.Emit("CreatePictureNotification", JsonConvert.SerializeObject(pictureNotification));
        }
    }

    public enum PictureNotificationType : int
    {
        CHAR_ABIGAIL,
