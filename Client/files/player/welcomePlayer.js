...
async function showInitMessage(pos) {
...
async function onBuyCommand(type, dmvPos) {
    if (type === "phone") {
...
async function onSendToDmv(dmvPos) {
...
async function onDmvFinish(commandUsed) {
    if (!commandUsed) {
...
async function onSendMessage(title, subTitle, message) {
