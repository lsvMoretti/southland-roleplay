...
class ClerkMarker {
    ...
    draw() {
        native.drawMarker(this.Type, this.PosX, this.PosY, this.PosZ - 1, this.DirX, this.DirY, this.DirZ, this.RotX, this.RotY, this.RotZ, this.Scale, this.Scale, this.Scale + 1, this.ColorR, this.ColorG, this.ColorB, this.ColorA, this.Bob, this.FaceCamera, 2, this.Rotate, null, null, false);
    }
}
